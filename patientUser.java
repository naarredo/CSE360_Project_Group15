...
private void showPatientRecords() {
    ...
    String recordPath = "C:/Users/karam/eclipse-workspace/asuHelloWorldJavaFX/Patients/" + userName +"/PatientRecords";
...
private void updatePatientInfo() {
    ...
    String userDirectoryPath = "C:/Users/karam/eclipse-workspace/asuHelloWorldJavaFX/Patients/" + userName;
...
private void loginValidation(String enteredUserName, String enteredPassword) {
    try {
        ...
        String userDirectoryPath = "C:/Users/karam/eclipse-workspace/asuHelloWorldJavaFX/Patients/" + enteredUserName;
...
private void savePatientInfoToFile() {
    ...
    String patientDirectoryPath = "C:/Users/karam/eclipse-workspace/asuHelloWorldJavaFX/Patients/" + userName;
...
String directoryPath = "C:/Users/karam/eclipse-workspace/asuHelloWorldJavaFX/Patients/" + userName;
...
private void createPatientDirectories(String basePath) {
    ...
    new File(basePath + "/sentMessages").mkdir();
    new File(basePath + "/receivedMessages").mkdir();
    new File(basePath + "/PatientRecords").mkdir();
}
